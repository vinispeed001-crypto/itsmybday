...
9. Testar as travas de duplo clique (Tasks 9/11): clicar duas vezes rapidamente em "Aceitar" num pedido pendente, e duas vezes rapidamente em "Gerar lista" — confirmar que nenhum dos dois cria linhas duplicadas em `integration_events` nem listas de convidados duplicadas.
